...
const CircleSvg = ({ stroke, ...props }: SVGProps<SVGSVGElement> & { stroke: string }) => (
  <svg
...
const TapePiece = ({
  ...
  rotation = 0,
  ...props
}: SVGProps<SVGSVGElement> & { rotation?: number }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 50 20"
...
const ContactPage = () => {
  ...
  return (
    <div
      className={`pt-[80px] pb-[60px] px-6 min-h-screen w-full flex items-center justify-center overflow-hidden relative`}
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(\"data:image/svg+xml,%3Csvg width='20' height='20' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='5' cy='5' r='0.5' fill='%239ca3af'/%3E%3Ccircle cx='15' cy='15' r='0.5' fill='%239ca3af'/%3E%3C/svg%3E\")",
      ...
      >
        ...
        <div className="flex flex-col text-center lg:text-left space-y-8 relative py-8 px-4">
          ...
          >
            <h1
              className={`text-5xl sm:text-6xl font-bold text-neutral-800 dark:text-neutral-100 relative inline-block`}
            >
              Got Ideas?
            </h1>
            <h1 className="text-5xl sm:text-6xl font-bold text-neutral-800 dark:text-neutral-100">
              Let&apos;s{" "}
              <span className={`text-${highlightColor}-500`}>Build</span>{" "}
              Something.
            </h1>
          </motion.div>
          ...
          >
            Contact me!
            <SmileySvg
              aria-label="doodled smiley face"
              className={`w-8 h-8 inline-block ml-2 text-neutral-700 dark:text-neutral-300`}
            />
          </motion.p>
          ...
          >
            ...
            <ArrowsSvg
              aria-label="arrows"
              className="fill-black sm:block hidden dark:fill-white scale-x-[-1] transition-all ease-in-out aspect-square sm:h-20 h-12 -rotate-[130deg]"
            />
            <div className="sm:hidden block relative w-full h-32">
              <CircleSvg
                stroke="white"
                className="block dark:hidden w-[350px] stroke-2 rotate-[5deg] h-[300px] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 fill-black dark:fill-white"
              />
              <CircleSvg
                stroke="black"
                className="hidden dark:block w-[350px] stroke-2 rotate-[5deg] h-[300px] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 fill-black dark:fill-white"
              />
              <a
            ...
            <ArrowsSvg
              aria-label="arrows"
              className="fill-black sm:block hidden dark:fill-white scale-x-[-1] transition-all ease-in-out aspect-square sm:h-20 h-12 rotate-[40deg]"
            />
          </motion.div>

          <p className="text-neutral-500 dark:text-neutral-500 text-center lg:text-left">
            (Or use one of these ↓ )
          </p>
        </div>
          ...
          <div className="grid sm:grid-cols-2 gap-6 p-2">
            {contactMethods.map((method, index) => (
              ...
              >
                ...
                <TapePiece
                  className="absolute -top-2 -left-2 w-10 h-5 group-hover:opacity-0 transition-all"
                  rotation={-25 + index * 10}
                />
                <TapePiece
                  className="absolute -bottom-2 -right-2 w-10 h-5 group-hover:opacity-0 transition-all"
                  rotation={160 - index * 10}
                />

                <div className="flex flex-col space-y-4">
                  <div className="flex items-center space-x-3">
                    <method.icon
                      className={`text-${method.color}-500 dark:text-${method.color}-400 text-3xl`}
                    />
